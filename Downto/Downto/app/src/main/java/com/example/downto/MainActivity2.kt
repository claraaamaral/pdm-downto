...
class MainActivity2 : AppCompatActivity() {
        ...
        private var testeDownto = TesteDownto("","","")

        lateinit var binding:ActivityMainBinding
        private val setRepost1Launcher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) {
                result ->

            if(result.resultCode == RESULT_OK){
                com.example.downto.testeDownto.button4 = result.data!!.getStringExtra("resposta").toString()

            }

        }
         val setRespostaActivity2 = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) {
            result ->
        if(result.resultCode == RESULT_OK){
            com.example.downto.testeDownto.textView5 = result.data!!.getStringExtra("resposta").toString()
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            binding.buttonTeste1.setOnClickListener{
                ...
                b.putInt("teste",1)
                intent.putExtras(b)
                setRepost1Launcher.launch(intent)
            }
            ...
            binding.button4.setOnClickListener {
                var acertos = 0
                if(testeDaltonismo.resp1.equals("") || testeDaltonis





                    mo.resp2.equals("") || testeDaltonismo.resp3.equals("")){
